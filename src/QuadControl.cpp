...
VehicleCommand QuadControl::GenerateMotorCommands(float collThrustCmd, V3F momentCmd)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  float F_tau_x = momentCmd.x / L * sqrt(2.f);
...
V3F QuadControl::RollPitchControl(V3F accelCmd, Quaternion<float> attitude, float collThrustCmd)
{
  ...
  if (collThrustCmd > 0)
  {
    float b_x = CONSTRAIN(-accelCmd.x * mass / collThrustCmd, -maxTiltAngle, maxTiltAngle);
    float b_y = CONSTRAIN(-accelCmd.y * mass / collThrustCmd, -maxTiltAngle, maxTiltAngle);

    float b_x_p = kpBank * (b_x - R(0, 2));
    float b_y_p = kpBank * (b_y - R(1, 2));
...
float QuadControl::YawControl(float yawCmd, float yaw)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  float yawRateCmd = kpYaw * (yawCmd - yaw);
  /////////////////////////////// END STUDENT CODE ////////////////////////////
